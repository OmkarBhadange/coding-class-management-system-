...
firstw=Tk()
firstw.title("CODING CLASS")
firstw.geometry("1600x1000+0+0")
label=Label(text="CODING CLASS",font=("times new roman",35),bg="MediumOrchid2")
...
def second():
    ...
    def distroy5():
        secondw.destroy()
        window()
    mainlabel= Label(secondw,text="Coding Class", font=("times new roman", 35), bg="MediumOrchid2")
    mainlabel.pack(side=TOP, fill=X)
...
def root():
    ...
    root.title("SHREE KRISHNA CLASSES")
    global entry1
    global entry2
    global entry3
    global entry4
